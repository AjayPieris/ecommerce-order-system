          ...
          {isAuthenticated ? (
            <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
              <div className="flex flex-col items-end hidden md:flex">
                <span className="text-xs font-bold text-gray-900">{userRole === "admin" ? "Admin" : "Customer"}</span>
                {userRole === "admin" && (
                  <Link to="/admin" className="text-[10px] text-gray-500 hover:text-gray-900">Dashboard →</Link>
                )}
                {userRole === "customer" && (
                  <Link to="/orders" className="text-[10px] text-gray-500 hover:text-gray-900">My Orders →</Link>
                )}
              </div>
